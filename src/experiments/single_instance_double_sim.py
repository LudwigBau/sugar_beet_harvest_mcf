...
filtered_size_scenarios = [
    ...
    {"nr_fields": 5, "nr_h": 2, "nr_l": 2},
    {"nr_fields": 10, "nr_h": 2, "nr_l": 2},
    {"nr_fields": 15, "nr_h": 2, "nr_l": 2},
    {"nr_fields": 20, "nr_h": 2, "nr_l": 2},
...
kpi_excel_file_path = os.path.join(
    BASE_DIR,
    f'../../data/results/excel/kpi_comparison_single_loader_flow_double_{today_date}.xlsx'
)
