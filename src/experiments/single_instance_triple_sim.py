...
print("Start -2 Single Instance Experiments")
...
# Experiment names
experiments = ["single_time_agg_g", "single_time_agg_h"]
...
filtered_size_scenarios = [
    ...
    {"nr_fields": 5, "nr_h": 3, "nr_l": 2},
    {"nr_fields": 10, "nr_h": 3, "nr_l": 2},
    {"nr_fields": 15, "nr_h": 3, "nr_l": 2},
    {"nr_fields": 20, "nr_h": 3, "nr_l": 2},
    {"nr_fields": 25, "nr_h": 3, "nr_l": 2}
...
kpi_excel_file_path = os.path.join(
    BASE_DIR,
    f'../../data/results/excel/kpi_comparison_single_loader_flow_triple_{today_date}.xlsx'
)
