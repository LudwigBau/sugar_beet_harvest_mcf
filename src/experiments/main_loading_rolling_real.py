...
data_file_2h = os.path.join(BASE_DIR, '../../data/results/instances/real_instance_data_2h.pkl')
instance_data_2h = pd.read_pickle(data_file_2h)

data_file_1h = os.path.join(BASE_DIR, '../../data/results/instances/real_instance_data_1h.pkl')
...
for group_id, group in enumerate(machine_groups):
    ...
    print(filtered_instance_data_1h[group_id].keys())
...
# save weekly_results
weekly_results_file_path = os.path.join(BASE_DIR, f'../../data/results/reporting/weekly_real_results_{today_date}.pkl')
...
solution_file_path = os.path.join(BASE_DIR, f'../../data/results/reporting/weekly_real_results_{today_date}.pkl')
